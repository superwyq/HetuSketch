...
import type { IndexSyncSummary, ProjectManifest } from '../../shared/storageTypes.js';
...
export class IndexService {
  ...
  startWatching(): void {
    ...
    this.watcher = chokidar.watch([join(this.paths.projectsRoot, '**', '*.json'), join(this.paths.projectsRoot, '**', '*.md')], {
      ignoreInitial: true,
